...
- BMA CRC method does not scale beyond $5$ lists easily because of the need to precompute all valid dependency structures between lists. Is less sensitive to errors from RL. [TODO we hope!]
