...
# number of cores = number of blocks
ncores <- length(blocks_tab)
...
proportions <- lapply(seq_len(n_fields), calcProp, data=df)
...
# run RL ----
chaperones(df, N, lam_prior, x1, init, x, z, id, cat_fields, string_fields, 
